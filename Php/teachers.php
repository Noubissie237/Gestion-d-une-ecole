<?php 
  ...
  $select = mysqli_query($con,"SELECT * FROM teacher");
?>
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="update.php?id='. $row['Id'] .'" class="me-3" ><span class="bi bi-pencil" id="edit">Edit</span></a>';
                                        echo "</td>";
                                          echo "<td>";
                                            echo '<a href="deleteTeacher.php?id='. $row['Id'] .'" ><span class="bi bi-trash" id="delete">Delete</span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
